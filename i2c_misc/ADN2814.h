...
#ifndef I2C_MISC_ADN2814_H_
#define I2C_MISC_ADN2814_H_
...
namespace cib
{
  namespace i2c
  {
    ...
    /*
     * Register description: https://www.analog.com/media/en/technical-documentation/data-sheets/ADN2814.pdf
     * 0x0[R] : Freq[7:0]
     * 0x1[R] : Freq[7:0]
     * 0x2[R] : 0 Freq[6:0]
     * 0x3[R] :
    ...
    public:
      ADN2814 ();
      virtual ~ADN2814 ();
      ADN2814 (const ADN2814 &other) = delete;
      ADN2814 (ADN2814 &&other) = delete;
